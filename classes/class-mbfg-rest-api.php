...
if ( ! class_exists( 'FBFG_Rest_API' ) ) {
	...
	final class FBFG_Rest_API {
		...
		public function delete_page_assets( $post_id ) {
			...
			delete_post_meta( $post_id, '_mbfg_page_assets' );
			delete_post_meta( $post_id, '_mbfg_css_file_name' );
			delete_post_meta( $post_id, '_mbfg_js_file_name' );
