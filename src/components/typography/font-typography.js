...
function FontFamilyControl( props ) {
	...
	const fonts = [
		{ value: "", label: __( "Default",'map-block-for-gutenberg' ), weight: [ "100", "200", "300", "400", "500", "600", "700", "800", "900" ], google: false },
	...
	return (
		<div className="mbfg-typography-font-family-options">
			<label className="mbfg-typography-font-family-label">{ __( "Font Family",'map-block-for-gutenberg' ) }</label>
			<Select
				options={ fonts }
			...
			/>
			<SelectControl
				label={ __( "Font Weight",'map-block-for-gutenberg' ) }
			...
			/>
			<SelectControl
				label={ __( "Font Subset",'map-block-for-gutenberg' ) }
